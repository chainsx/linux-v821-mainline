...
void *xradio_iface_add_net_dev(void *priv, u8 if_type, u8 if_id,
				char *name,
				int (*tx_func)(void *priv,
					       struct sk_buff *skb));
void xradio_iface_remove_net_dev(void *priv);
int xradio_add_net_dev(struct xradio_plat *priv, u8 if_type, u8 if_id,
			char *name);
...
int xradio_add_net_dev_ap(struct xradio_plat *priv, u8 if_type, u8 if_id,
			  char *name);
